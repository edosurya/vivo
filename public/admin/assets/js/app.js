!(function (s) {
    ...
    function t(e) {
        ...
        let joinUrl = `${baseUrl[0]}//${baseUrl[2]}/admin/`;
        ...
        1 == s("#light-mode-switch").prop("checked") &&
            ...
            ? (s("html").removeAttr("dir"),
                ...
                s("#bootstrap-style").attr(
                    "href",
                    `${joinUrl}assets/css/bootstrap.min.css`
                ),
                s("#app-style").attr("href", `${joinUrl}assets/css/app.min.css`),
            ...
            : 1 == s("#dark-mode-switch").prop("checked") &&
                ...
                ? (s("html").removeAttr("dir"),
                    ...
                    s("#bootstrap-style").attr(
                        "href",
                        `${joinUrl}assets/css/bootstrap-dark.min.css`
                    ),
                    s("#app-style").attr("href", `${joinUrl}assets/css/app-dark.min.css`),
    ...
    s("#side-menu").metisMenu(),
        ...
        (function () {
            ...
            var a = s(this).attr("data-delay")
                ? s(this).attr("data-delay")
                : 100,
                n = s(this).attr("data-time")
                    ? s(this).attr("data-time")
                    : 1200;
