...
use App\Notifications\Smtp\ReminderH7Notification;

class SendH7MailController extends Controller
{
    /**
        ...
        try {
            ...
            if(count($reservationIds) > 1){
                ...
                foreach ($reservations as $key => $reservation) {
                    $reservation->notify(new ReminderH7Notification($reservation));
                }
            }else{
