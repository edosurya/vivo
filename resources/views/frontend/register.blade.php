...
<!--                          <div class="mb-3 col-md-12 mb-0 pb-0">
                            ...
                            <label class="invalid-feedback fw-bold mb-3" id="imgDescErrorMessagee"></label>
                        </div> -->
 ...
 <label class="invalid-feedback fw-bold mb-3" id="imgDescErrorMessage"></label>
    ...
    <li class="data-details mb-2 rounded-2 bg-blue-gradient-90" data-id="">
        ...
        <!-- Tambahan input Judul dan Deskripsi -->
        <div class="dz-image-desc mt-2 p-2">
            <input type="text" class="form-control mb-2 dz-title" name="img_title[]" placeholder="Judul Foto (maks. 50 karakter)" maxlength="50">
            <textarea class="form-control dz-caption" name="img_caption[]" placeholder="Deskripsi Foto (maks. 250 karakter)" rows="2" maxlength="250"></textarea>
        </div>
