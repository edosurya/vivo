...
@section('content')
        ...
        <div class="container-lg mb-5">
          <div class="row justify-content-center">
            <div class="col-12 col-md-5 mb-3">
              <h5 class="text-white vivo_heavy text-uppercase mb-3">SYARAT & KETENTUAN</h5>
                <ul class="text-white">
            ...
            <div class="col-12 col-md-7 mb-3">
              <h4 class="text-white vivo_heavy text-uppercase mb-3">REGISTRASI SEKARANG</h4>
              <div class="invalid-feedback fw-bold mb-3" id="dzErrorMessage"></div>
                ...
                <form id="dzImageUploadForm" action="/upload" method="post" enctype="multipart/form-data" data-aos="fade-up">
                    ...
                    <div class="row text-white">
                        ...
                        <h4 class="text-white vivo_heavy text-uppercase mb-3 mt-5">UPLOAD</h4>
                        ...
                        <div class="mb-3 col-md-12 mb-0 pb-0">
                            ...
                            <textarea class="form-control indosat_body" name="img_desc" id="img_desc" rows="4" cols="50"> Maksimal 250 karakter</textarea>
                         ...
                         <div class="mb-3 col-md-12 mb-0 pb-0">
                            <div class="form-group mb-3">
                                <div class="main-drag-area form-control p-0 border-0" id="dzDropzone">
                                    <div class="dz-message rounded-3 text-muted bg-blue-gradient-90 p-3 mb-2" id="dzPlaceholder">
    ...
    <script id="dzAdditionalTemplate" type="text/template">
        <div class="dz-additional-area text-muted position-relative form-control d-flex align-items-center justify-content-center bg-blue-gradient-90 mb-2 rounded-2 border-0">
            <span class="text-black vivo_bold">Upload Photo</span>
            <svg class="dz-photo-icon opacity-75" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                <path d="M15 8h.01" /><path d="M3 6a3 3 0 0 1 3 -3h12a3 3 0 0 1 3 3v12a3 3 0 0 1 -3 3h-12a3 3 0 0 1 -3 -3v-12z" /><path d="M3 16l5 -5c.928 -.893 2.072 -.893 3 0l5 5" /><path d="M14 14l1 -1c.928 -.893 2.072 -.893 3 0l3 3" />
            </svg>
